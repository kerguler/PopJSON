...
int ode_func(double t, const double y[], double f[], void *params) {
    ...
    double rate_r0 = (model_param[time_scale] * model_param[sigma] * size_yy);
    f[0] += ((double)1) * rate_r0;

    double rate_r1 = (model_param[time_scale] * model_param[sigma] * size_xx);
    f[0] -= ((double)1) * rate_r1;

    double rate_r2 = (model_param[time_scale] * model_param[rho] * size_xx);
    f[1] += ((double)1) * rate_r2;

    double rate_r3 = (model_param[time_scale] * size_xx * size_zz);
    f[1] -= ((double)1) * rate_r3;

    double rate_r4 = (model_param[time_scale] * size_yy);
    f[1] -= ((double)1) * rate_r4;

    double rate_r5 = (model_param[time_scale] * size_xx * size_yy);
    f[2] += ((double)1) * rate_r5;

    double rate_r6 = (model_param[time_scale] * model_param[beta] * size_zz);
    f[2] -= ((double)1) * rate_r6;
