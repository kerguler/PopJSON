...
void sim(int *tf, int *rep, double *envir, double *pr, double *y0, char **file_from, char **file_to, double *ret, double *iret, int *success) {
    ...
    char arbiters[2];
    number key[2];
    size_adult_0 = numZERO;
    size_adult_1 = numZERO;
    size_adult_2 = numZERO;
    size_adult_3 = numZERO;
    size_adult_4 = numZERO;
    size_adult_5 = numZERO;
    size_adult_6 = numZERO;
    size_adult_7 = numZERO;
    size_adult_8 = numZERO;
